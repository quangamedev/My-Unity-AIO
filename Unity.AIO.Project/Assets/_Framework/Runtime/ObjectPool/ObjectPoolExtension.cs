...
public static class ObjectPoolExtension
{
    ...
    public static T SpawnFromPool<T>(this T component, Vector3 position, Quaternion rotation, Transform parent = null) where T : Component
    {
        var spawnedObject = ObjectPool.Instance.Spawn(component);
        var spawnedObjectTransform = spawnedObject.transform;
        spawnedObjectTransform.position = position;
        spawnedObjectTransform.rotation = rotation;
